    ...
    <div className="flex flex-col items-center justify-center mt-8 laptop:mt-16 gap-4 laptop:gap-8">
      ...
      <div className="w-full flex flex-wrap gap-4 laptop:gap-8  justify-center">
        ...
        <ProductCard
          ...
          text="Dive into our unique delights at AfricaWorldMarket! Each product offers a special taste of African culture. Experience new flavors and ingredients that will excite your palate and inspire your cooking!"
        />
        <ProductCard
          src={peppers}
          btnTxt="Shop Fresh!"
          ...
          text="At AfricaWorldMarket, we prioritize freshness! Our local finds include seasonal produce and authentic ingredients sourced directly from trusted farms. Enjoy the best quality for your meals today!"
        />
      </div>
